...
#
#  $ bin/test -s mordac2.quota -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src mordac2.quota.testing.MORDAC2_QUOTA_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/mordac2/quota/tests/robot/test_example.robot
#
